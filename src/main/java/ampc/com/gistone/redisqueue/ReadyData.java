...
public class ReadyData {
	...
	public void readyRealMessageData(HashMap<String, Object> body) {
		...
		queueData.setId(UUID.randomUUID().toString());//消息id
		queueData.setTime(time);
		...
		String modeltype = buffer.toString();// modeltype 1_4
		...
		//判断tasks准备的时候 lastfnl 是否是小于today-1 如果小于 则lastfnl 则不发送数据包
				//获取lastfnl ，initial
		Map<String, Object> map = ReadyData.getlastfnl();
		String lastfnl = (String) map.get("lastfnl");
		//initial 初始化的时候是true 其他情况都是false
		boolean initial =  (boolean) map.get("initial");
		commonData.setFirsttime(initial);
		//准备common的数据
		ReadyData.getRealcommonMSG(scenarinoId,lastfnl,scenarinoType);
	 ...
	 */
	private  void getRealcommonMSG(Long scenarinoId, String lastfnl,
	 ...
	 */
	private  Map<String, Object> getlastfnl() {
		Map<String, Object> hashMap = new HashMap<String, Object>();
		boolean initial = false;
		String oldlastfnl;
		TUngrib tUngrib = tUngribMapper.getlastfnl();
