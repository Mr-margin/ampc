...
//            }],
    ...
    /*function _onmouseover() {
     isMouseDrag = 2;
     var option = plancharts.getOption();
     plancharts.setOption($.extend(true, {}, option, {
     xAxis: {
     axisPointer: {
     value: echarts.format.formatTime('yyyy-MM-dd hh:mm:ss', 1493920799000),
     snap: true,
     lineStyle: {
     color: '#004E52',
     opacity: 0.5,
     ...
     allData.plancharts.setOption(option);
     //            plancharts.on('mouseover',function () {
     //
     //            });
     }*/

    /*        function _offmouseover() {
     var option = plancharts.getOption();
     delete option.xAxis.axisPointer;
     plancharts.setOption(option);
     }*/

    plancharts.setOption(_option);
    /*        plancharts.on('mousedown', function (params) {
     isMouseDrag = 1;
     setTimeout(function () {
     isMouseDrag = 2;
     }, 700);
