...
public class Interpolation {
  ...
  public static double interpolation(int hour, int layer, double xorig, double yorig, double xcell, double ycell, int row, int col, Variable variable, Point2D point2D) throws IOException, InvalidRangeException {
