...
public class ObsPreprocessController {
	...
	public AmpcResult preprocess(@RequestBody Map<String, Object> requestData,
		...
		if(startDate == null || endDate == null || area == null || res == null || areaIds == null) return AmpcResult.build(-1, "参数错误");
		
		if(obsService.RESOLUTION_DAY.equals(res)) {
