...
public class AirController {
	...
	public AmpcResult findAllTimeSeries(@RequestBody Map<String,Object> requestDate,HttpServletRequest request, HttpServletResponse response){
		try{
			...
			Date calDate;
			String calDateStr;
			Object[] simulationArr={"BC","PM25","CO","O3_1_MAX","NO2","NO3","PMFINE","SO2","PM10","SO4","AQI","O3_8_MAX","NH4","O3_AVG","OM"};	//逐日模拟数据
			Object[] simulationHour={"BC","O3","PM25","CO","NO2","NO3","OC","PMFINE","SO2","PM10","SO4","AQI","NH4","OM"};	//逐小时模拟数据
			Object[] speciesArr={"NO2","PM2_5","O3","SO2","PM10","AQI","O3_8h","CO"};	//观测数据
...
//		sumMapsum.put(how, sumMap);//观测数据和
	 ...
	 * @return
	 */
	@RequestMapping("Air/MeteorologicalData")
	public AmpcResult MeteorologicalData(@RequestBody Map<String,Object> requestDate,HttpServletRequest request, HttpServletResponse response){
