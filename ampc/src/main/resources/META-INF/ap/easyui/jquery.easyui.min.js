...
(function ($) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        loader: function (_86e, _86f, _870) {
            ...
            /*判断queryParams类型，进行数据变换*/
            if($.isFunction(opts.queryParams)){
            ...
            $.ajax({
                ...
                /*更改请求参数格式 end*/
                type: opts.method, url: opts.url,
                /*请求参数字符串化 start*/
                // data: JSON.stringify(data),
                /*请求参数字符串化 end*/
                // data: _86e,
                data:opts.contentType == 'application/json'?JSON.stringify(data):data,
